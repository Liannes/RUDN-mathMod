...
![Фазовый портрет для случая 1](image\1.1.png){#fig:002 width=70%}
...
![График решения для случая 2](image\2.png){#fig:003 width=70%}

![Фазовый портрет для случая 2](image\2.1.png){#fig:004 width=70%}
...
# Вывод
В ходе выполнения работы я понял как построить решения уравнения гармонического осциллятора, фазового портрета гармонических колебаний без затухания, с затуханием, а также при воздействии внешней силы.
