...
![Фазовый портрет для случая 1](image/1.1.png){ #fig:002 width=70% height=70% }

## Случай 2. Колебания гармонического осциллятора c затуханием и без действий внешней силы

$\ddot{x}+\dot{x}+10x=0$

![График решения для случая 2](image/2.png){ #fig:003 width=70% height=70% }

## Случай 2. Колебания гармонического осциллятора c затуханием и без действий внешней силы

$\ddot{x}+\dot{x}+10x=0$

![Фазовый портрет для случая 2](image/2.1.png){ #fig:004 width=70% height=70% }
